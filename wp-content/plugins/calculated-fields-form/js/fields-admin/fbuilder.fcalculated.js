	...
	$.extend(
        ...
        showDynamicEval:function()
			{
				return '<label><input type="checkbox" name="sDynamicEval" id="sDynamicEval" '+((!this.dynamicEval)?"checked":"")+'> Do not evaluate dynamically </label><i>(Its equation will be evaluated by pressing a calculation button or by calling the EVALEQUATION operation)</i><div class="clearer"></div>';
			},
